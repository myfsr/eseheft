...
Internetseite \footnote{\url{https://.myfsr.de}} und vorallem persönlich im Raum
...
\begin{description}
  ...
  \item[Veranstaltungen] Wir bieten Veranstaltungen an wie beispielsweise
    ...
    abonniere den νsletter des μFSR\footnote{\url{www.myfsr.de/minitrue/auth/page/email/register\#}}.
...
\begin{description}
  \clitem{ZIH-Login aktivieren} Das Zentrum für Informationsdienste und Hochleistungsrechnen (\keyword{ZIH})
    ...
    Informationen dazu und zu allen (folgenden) IT-Diensten finden sich ausführlich auf den Erstsemesterseiten des ZIH \footnote{\url{www.tu-dresden.de/zih/dienste/service-desk/ese}\label{zihurl}}.
  ...
  \clitem{eduroam} Auf dem gesamten Unigelände und in zahlreichen Unis auf der ganzen Welt steht dir
    ...
    \clitem{νsletter} Melde dich doch für den Newsletter des μFSR an\footnote{www.myfsr.de/minitrue/auth/page/email/register\#}.
...
\begin{description}
  ...
  \item[SELMA] SELMA heißt Selbstmanagement und ist ein neues Portal für das Organisatorische
    im Studium. Für Mathematik-Studierende braucht man es zum Herunterladen der Immatrikulationsbescheinigung
    und den Informationen zur Rückmeldung zum nächsten Semester und zum Melden einer neuen Adresse bei Umzug.
    Man nutzt die ZIH-Login-Daten.
  \item[HISQIS] HISQIS ist das Portal zum Anmelden zu Prüfungen. Es soll irgendwann durch SELMA abgelöst werden.
  ...
  \item[Prüfungsamt] Für alle Prüfungen für Mathematik Bachelor Studierende ist
    ...
    {\nolinkurl{karola.schreiter@tu-dresden.de}}} (WIL C 109, Mo bis Do 12:30---14:00) zu wenden.
...
\begin{description}
  \item[ESE] % TODO:  <05-09-17, Bela> von Markus endgültige Liste bekommen %
  \item[KrETa] % TODO:  <05-09-17, Bela> spannendes aus KrETa raussuchen %
...
\begin{itemize}
  \item 
    % TODO:  <05-09-17, Bela> Zeitraum der Anmeldung zu Prüfungen %
  ...
  \item Hochschulwahlen: voraussichtlich 28.11.2018---30.11.2018. Gewählt wird:
    % TODO:  <05-09-17, Bela> bitte korrigieren, falls etwas fehlt %
    \begin{itemize}
...
\newpage
\input{../stav/stavpage.tex}

\newpage
\input{../arbeiterkind/arbeiterkindpage.tex}
