...
\documentclass[twoside, toc=sectionentrywithdots]{scrartcl}
...
\usepackage{enumitem}
\usepackage[a5paper, margin=1cm, top=1.5cm, headsep=0pt]{geometry}
% \usepackage[width=152truemm,height=214truemm,center]{crop}
...
\usepackage{wrapfig}
\setlist{nosep} % Listen werden kompakter
% Platzsparen bei section überschriften
...
\RedeclareSectionCommand[
  afterskip=1ex plus .2ex,
  beforeskip=-1.5ex plus -1ex minus -.7ex,
  indent=0pt,
  level=2,
  tocindent=3.8em,
  tocnumwidth=3.2em
...
% is done:  <06-09-17, Bela> Deckblatt: μFSR-Bild, dafür nach Möglichkeit ein neues machen (Bene, Luisa, Felix sind weg, Assoziierte können mit rauf) %
\newpage
...
%    \includegraphics[width=\textwidth]{./fsrfoto.jpg}
    ...
    \begin{tabular}{llll}
      ...
      Fr, 6.10. & µ-sli\footnote{ohne Müsli}  & 11:10--12:40 & WIL/C107 \\
                     ...
                     & & & WIL/C104 \\
      \hline
      Sa, 7.10. & Wanderung & ab 10:20 & Hauptbahnhof Gleis 18
    \end{tabular}
  \begin{Large}
    Kritische Einführungstage (KRETA)\footnote{\url{https://kreta-dresden.org/}} (Kleine (!) Auswahl)
  \end{Large}
  \begin{tabular}{lp{0.4\textwidth}lp{0.2\textwidth}}
      Datum        & Was & Zeit & Wo? \\
      \hline
...
\addcontentsline{toc}{section}{Vorstellung Fachschaftsrat Mathematik}
...
alle findet man auf der Internetseite des StuRa\footnote{\url{www.stura.tu-dresden.de/hochschulgruppen}} und in der Broschüre \enquote{Studentische Hochschulgruppen}\footnote{\url{https://www.stura.tu-dresden.de/webfm_send/2319}}.
%
\section*{Termine Wintersemester}\label{sec:termine}
\addcontentsline{toc}{section}{Termine Wintersemester}
\begin{description}
  ...
  \item[Informationen vom Studentenwerk] Das Studentenwerk wird am 5.10., 19.10.\ und 26.10.\ 
    jeweils 11:00--17:00 Uhr zu seinen vielen Serviceangeboten
    am Servicepunkt im Eingangsbereich der SLUB informieren.% Es gibt auch Give-aways und Nützliches.  
  \item[Hochschulwahlen] voraussichtlich 28.11.2018---30.11.2018. Gewählt wird:
    \begin{itemize}
      \item FSR (11 Mitglieder)
      \item Fakultätsrat Mathematik (3 Studierende)
      \item Fakultätsrat Mathematik und Naturwissenschaften (4 Studierende)
      \item Senat, erweiterter Senat (je 4 Studierende)
    \end{itemize}
    Wenn du dich in eines diesen Gremien wählen lassen möchtest, melde dich bei uns bis zum \keyword{07.11.2017}!
  \item [Weihnachtsfeier X-Math-Party] im Dezember.
  \item [Prüfungsanmeldung] Ab Anfang Januar 
...
\addcontentsline{toc}{section}{Checkliste Uniservices}
...
\begin{description}
  \clitem{ZIH-Login aktivieren} Das Zentrum für Informationsdienste und Hochleistungsrechnen (\keyword{ZIH})
    bietet alle IT-Dienste für die TUD an. Du braucht daher einen \keyword{ZIH-Login}, den du bei der
    Immatrikulation bekommen hast, aber noch aktivieren musst.
  ...
  \clitem{Sportkurse} Das Universitätssportzentrum (\keyword{USZ})\footnote{\url{www.tu-dresden.de/usz/zentrale-infos/hinweise-zur-buchung}} bietet ein riesiges Angebot\footnote{\url{www.usz.tu-dresden.de}} an
    ...
    % is done halfway: <30-08-17, Bela> wie heißt die Schnellanmeldefunktion? Die ist als Kurs registriert. %
...
\end{description}
\addcontentsline{toc}{section}{weitere Uniservices}
...
\begin{description}
  ...
  \item[ownCloud] Unter anderem bietet das ZIH dir 2GB Online-Speicher\footref{zihurl} an.
    Dieser läuft unter dem Namen CloudStore\footnote{\url{https://cloudstore.zih.tu-dresden.de}\footref{snr}} (beziehungsweise dem Namen der verwendeten Software ownCloud).
  ...
  \item[Studienfachberatung] Die Studienfachberatung berät zu
    ...
    \footnote{\url{www.tu-dresden.de/mn/math/studium/beratung/bachelor_mathematik}} an, für das Lehramt Mathematik Dr.\ Karin Weigel\footnote{\url{www.tu-dresden.de/mn/math/studium/beratung/bachelor_mathematik}}.
  \item[Zentrale Studienberatung] Die zentrale Studienberatung\footnote{\url{www.tu-dresden.de/studium/im-studium/beratung-und-service/zentrale-studienberatung}} ist der erste Ansprechpartner wenn über einen Studiengangswechsel nachgedacht wird. Daneben bietet sie aber auch weitere Angebote,
    ...
    % Nichtsdestotrotz haben die meisten innerhalb des Mathematikstudiums keinen Kontakt damit.
  ...
  \item[Schreibzentrum] Das Schreibzentrum bietet Unterstützung an beim Schreiben von wissenschaftlichen Arbeiten, siehe auch deren Seite \pageref{sec:schreibzentrum}.
  \item[Studiendokumente] Um nicht von bisher unbekannten Regelungen
    ...
    \footnote{\flushleft Bachelor: \url{www.tu-dresden.de/mn/studium/studiendokumente-formulare/mathematik-bachelor}\\
  ...
  \item [Finanzierungsbroschüre] Der StuRa hat eine ausführliche Zusammenstellung von Möglichkeiten
    das Leben während des Studiums zu finanzieren\footnote{\url{https://stura.link/finanzierung}} herausgegeben.
    Du kannst sie dir auch ausgedruckt im StuRa\footnote{Wo: \url{https://www.stura.tu-dresden.de/service}} abholen.
\end{description}
...
\newpage
\addcontentsline{toc}{section}{Hochschulgruppen u.ä.\ stellen sich vor}
\input{./radiopage.tex}
\input{./unisanpage.tex}

\newpage
\input{./consonarepage.tex}
\input{stavpage}

\newpage
\input{./ksgesgpage.tex}
\input{arbeiterkindpage}

\newpage
% \input{./psychoberatungpage.tex}
\includepdf{./psychoberatungplakat-gray.pdf}

\newpage
\includepdf{./tandem-plakat-gray.pdf}

% \newpage

\newpage
\input{./courage-page.tex}

\newpage
\input{./schreibzentrumpage.tex}

\newpage
\addcontentsline{toc}{section}{Ersti-Fahrt}
\input{./erstifahrtpage.tex}
\end{document}
